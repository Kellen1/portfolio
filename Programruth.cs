...
namespace realpayment
{
    class Program
    {
        class payment                              // class is created
        {
            ...
            public void get(int choose)             // overloading show method
            {
        ...
        static void Main(string[] args)
        {
            ...
            payment employee1 = new payment(employeename, employeeid);        //calling a two parameter constructor
            employee1.get();                                                   // calling show method
            employee1.get(2);                                                  // calling overloaded method
